...
ff_waste <- read_excel("data/Wastes_August_september_m.xlsx", sheet="9000_E06")
...
ff_defects <- read_excel('data/inspection_results_and_defects_August_september.xlsx', 'Defects')
...
pdf("data/output/r/01_waste_defect_corr.pdf", width = 7.9) # Open a new pdf file
...
pdf("data/output/r/01_waste_defect_plot.pdf", width = 7.9) # Open a new pdf file
...
ff_results <- read_excel('data/inspection_results_and_defects_August_september.xlsx', 'Inspection results')
...
pdf("data/output/r/02_waste_revisions_corr.pdf", width = 7.9) # Open a new pdf file
chart.Correlation(frl)
dev.off()
...
pdf("data/output/r/02_waste_revisions_plot.pdf", width = 7.9) # Open a new pdf file
...
pdf("data/output/r/03_defects_revisions_corr.pdf", width = 7.9) # Open a new pdf file
chart.Correlation(frl)
dev.off()
...
pdf("data/output/r/03_defects_revisions_plot.pdf", width = 7.9) # Open a new pdf file
...
pdf("data/output/r/04_temperature_waste_corr.pdf", width = 7.9) # Open a new pdf file
chart.Correlation(frl)
dev.off()
...
pdf("data/output/r/04_temperature_defects_corr.pdf", width = 7.9) # Open a new pdf file
chart.Correlation(frl)
dev.off()
...
pdf("data/output/r/04_temperature_revisions_corr.pdf", width = 7.9) # Open a new pdf file
chart.Correlation(frl)
dev.off()
...
pdf("data/output/r/05_temperature_wrd_corr.pdf", width = 7.9) # Open a new pdf file
chart.Correlation(frl)
dev.off()
...
pdf("data/output/r/05_temperature_wrd_plot.pdf", width = 7.9) # Open a new pdf file
